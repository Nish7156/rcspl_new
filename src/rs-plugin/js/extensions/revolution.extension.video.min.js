  ...
  jQuery.extend(!0, t, {
      ...
      switch (t.data("videotype")) {
        case "youtube":
          ...
          try {
            if ("on" == t.data("forcerewind") && !a) {
              ...
              (i = -1 == i ? 0 : i),
                t.data("player").seekTo(i),
                t.data("player").pauseVideo();
            }
          } catch (o) {}
          0 == t.find(".tp-videoposter").length &&
            punchgs.TweenLite.to(t.find("iframe"), 0.3, {
              autoAlpha: 1,
              display: "block",
        ...
        case "html5":
          ...
          var n = t.find("video"),
            r = n[0];
          if (
            (punchgs.TweenLite.to(n, 0.3, {
              autoAlpha: 1,
              display: "block",
              ease: punchgs.Power3.easeInOut,
            }),
            "on" == t.data("forcerewind") && !t.hasClass("videoisplaying"))
          )
            try {
              var i = e(t.data("videostartat"));
      ...
      switch ((clearTimeout(o.data("videoplaywait")), o.data("videotype"))) {
        case "youtube":
          if (0 == o.find("iframe").length)
            o.append(o.data("videomarkup")), d(o, n, !0);
          ...
          jQuery("head")
            ...
            .each(function () {
              jQuery(this).attr("src") ==
                i + "://a.vimeocdn.com/js/froogaloop2.min.js" && (n = !1);
            }),
    ...
    manageVideoLayer: function (o, r) {
      var s = o.data("videoattributes"),
        ...
        g = "http",
        y =
          "loop" == o.data("videoloop")
            ? "loop"
            : "loopandnoslidestop" == o.data("videoloop")
            ? "loop"
            : "",
        w =
          void 0 != u || void 0 != c
            ? "html5"
            : void 0 != p && String(p).length > 1
            ? "youtube"
            : void 0 != l && String(l).length > 1
            ? "vimeo"
            : "none",
        b =
          "html5" == w && 0 == o.find("video").length
            ? "html5"
            : "youtube" == w && 0 == o.find("iframe").length
            ? "youtube"
            : "vimeo" == w && 0 == o.find("iframe").length
            ? "vimeo"
            : "none";
      switch ((o.data("videotype", w), b)) {
        case "html5":
          ...
          void 0 != c &&
            ...
            (k = k + '<source src="' + c + '" type="video/webm" />'),
            void 0 != u &&
              (k = k + '<source src="' + u + '" type="video/mp4" />'),
            void 0 != f &&
              (k = k + '<source src="' + f + '" type="video/ogg" />'),
            (k += "</video>");
          var T = "";
          ("true" === m || m === !0) &&
            (T =
            ...
            "controls" == h &&
              (k +=
                ...
                T +
                "</div>"),
            o.data("videomarkup", k),
            o.append(k),
            ((a && 1 == o.data("disablevideoonmobile")) || t.isIE(8)) &&
              o.find("video").remove(),
        ...
        case "youtube":
          (g = "http"),
            "https:" === location.protocol && (g = "https"),
            "none" == h &&
              ((s = s.replace("controls=1", "controls=0")),
              -1 == s.toLowerCase().indexOf("controls") &&
                (s += "&controls=0"));
          var x = e(o.data("videostartat")),
            L = e(o.data("videoendat"));
          -1 != x && (s = s + "&start=" + x), -1 != L && (s = s + "&end=" + L);
          ...
          "https:" === location.protocol && (g = "https"),
            o.data(
              ...
              '<iframe style="visible:hidden" src="' +
                ...
                "?" +
                s +
                '" width="100%" height="100%" style="100%;height:100%"></iframe>'
            );
      }
      var I =
        (1 != a &&
          "on" != o.data("posterOnMobile") &&
          "on" != o.data("posteronmobile")) ||
        a;
      void 0 != o.data("videoposter") && o.data("videoposter").length > 2 && I
            ...
            o.find(".tp-videoposter").click(function () {
              if ((t.playVideo(o, r), a)) {
                ...
                punchgs.TweenLite.to(o.find(".tp-videoposter"), 0.3, {
                  ...
                  punchgs.TweenLite.to(o.find("iframe"), 0.3, {
                    autoAlpha: 1,
                    display: "block",
                    ease: punchgs.Power3.easeInOut,
                  });
        ...
        : 0 != o.find("iframe").length ||
          ("youtube" != w && "vimeo" != w) ||
          (o.append(o.data("videomarkup")), d(o, r, !1)),
        "none" != o.data("dottedoverlay") &&
          void 0 != o.data("dottedoverlay") &&
          1 != o.find(".tp-dottedoverlay").length &&
          o.append(
            '<div class="tp-dottedoverlay ' +
              o.data("dottedoverlay") +
              '"></div>'
          ),
        o.addClass("HasListener"),
        1 == o.data("bgvideo") &&
          punchgs.TweenLite.set(o.find("video, iframe"), { autoAlpha: 0 });
    },
  });
  var i = function (e, t, a) {
    ...
    d = function (i, d, n) {
      ...
      if (
        ...
        void 0 != c &&
          c.split(":").length > 1 &&
          t.prepareCoveredVideo(c, d, i);
      }
      if (
        (p.attr("id", l),
        n && i.data("startvideonow", !0),
        1 !== i.data("videolistenerexist"))
      )
        switch (i.data("videotype")) {
                  ...
                  if (t.data == YT.PlayerState.PLAYING)
                    punchgs.TweenLite.to(p.find(".tp-videoposter"), 0.3, {
                      ...
                      "mute" == p.data("volume")
                        ? l.mute()
                        : (l.unMute(),
                          l.setVolume(parseInt(p.data("volume"), 0) || 75)),
                      (d.videoplaying = !0),
                      r(p, d),
                      n.trigger("stoptimer"),
                      d.c.trigger(
          ...
          case "vimeo":
            for (
              var m, h = p.attr("src"), g = {}, y = h, w = /([^&=]+)=([^&]*)/g;
              (m = w.exec(y));

            )
              g[decodeURIComponent(m[1])] = decodeURIComponent(m[2]);
            h =
              void 0 != g.player_id
                ? h.replace(g.player_id, l)
                : h + "&player_id=" + l;
            try {
              ...
              if (
                ...
                k.addEvent("play", function () {
                  i.data("nextslidecalled", 0),
                    ...
                    "mute" == i.data("volume")
                      ...
                      : k.api(
                          "setVolume",
                          parseInt(i.data("volume"), 0) / 100 || 0.75
                        );
                }),
                  ...
                  if (
                    ...
                    if (v) {
                      ...
                      1 == i.data("nextslideatend") &&
                        (i.data("nextslidecalled", 1), d.c.revnext()),
                        k.api("pause");
                }),
                k.addEvent("finish", function () {
                  s(i, d),
                    ...
                    1 == i.data("nextslideatend") && d.c.revnext();
                }),
        ...
        switch (i.data("videotype")) {
          case "youtube":
            n &&
              (i.data("player").playVideo(),
              -1 != T && i.data("player").seekTo());
            break;
          case "vimeo":
            if (n) {
    ...
    n = function (d, n) {
      ...
      if (
        ...
        void 0 == p.attr("control") &&
          (0 != d.find(".tp-video-play-button").length ||
            a ||
            d.append(
      ...
      void 0 != m &&
        ...
        i(h, "click", function () {
          0 == l.muted
            ? ((l.muted = !0), (h.innerHTML = "Unmute"))
            : ((l.muted = !1), (h.innerHTML = "Mute"));
        }),
        g &&
          i(g, "click", function () {
            l.requestFullscreen
          ...
          if (
            ...
            if (u) {
              ...
              1 == d.data("nextslideatend") &&
                (d.data("nextslidecalled", 1), n.c.revnext()),
                l.pause();
        }),
        ...
        i(l, "play", function () {
          d.data("nextslidecalled", 0),
            ...
            punchgs.TweenLite.to(d.find(".tp-videoposter"), 0.3, {
              autoAlpha: 0,
              force3D: "auto",
              ease: punchgs.Power3.easeInOut,
            }),
            punchgs.TweenLite.to(d.find("video"), 0.3, {
              autoAlpha: 1,
              display: "block",
              ease: punchgs.Power3.easeInOut,
            });
          ...
          void 0 != e && (e.innerHTML = "Pause"),
            void 0 != t && l.muted && (t.innerHTML = "Unmute");
        }),
        i(l, "pause", function () {
        ...
        i(l, "ended", function () {
          s(d, n),
            ...
            1 == d.data("nextslideatend") && n.c.revnext(),
            d.removeClass("videoisplaying");
        });
    },
    r = function (e, a) {
