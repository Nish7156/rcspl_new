  ...
  var e = function (e, o, a, i) {
    ...
    i = function (t, i, n, r, s, l, d, h, f) {
      ...
      (y =
        ...
        11 != t &&
          (null != v[7] && e(h, r, v[7], v[5]),
          null != v[6] && e(d, r, v[6], v[5])),
        f.add(
      ...
      if (16 == t) {
        ...
        var re = (l.find(".defaultimg"), Math.round(20 * Math.random() - 10)),
          ...
          he = 0.4 * Math.random() - 0.2,
          fe = 1 * Math.random() + 1,
          ce = 1 * Math.random() + 1,
          pe = 0.3 * Math.random() + 0.3;
        f.add(
        ...
        d.find(".slotslide").each(function () {
          ...
          1 != g
            ? ((we = -r.width),
              (ue = 90),
              25 == t
                ? ((ge = "center top 0"), (ve = -ue), (ue = r.rotate))
                : ((ge = "left center 0"), (ve = r.rotate)))
            : ((we = r.width),
              (ue = -90),
              25 == t
                ? ((ge = "center bottom 0"), (ve = -ue), (ue = r.rotate))
                : ((ge = "right center 0"), (ve = r.rotate))),
          h.find(".slotslide").each(function () {
            var t = jQuery(this);
            f.add(
              punchgs.TweenLite.fromTo(
