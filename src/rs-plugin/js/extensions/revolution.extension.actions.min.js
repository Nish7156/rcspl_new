  ...
  var checkActions_intern = function (_nc, opt, as) {
                  ...
                  function () {
                    switch (a.action) {
                      case "scrollbelow":
                        ...
                        var off =
                            getOffContH(opt.fullScreenOffsetContainer) || 0,
                      ...
                      case "togglefullscreen":
                        if (
                          ...
                          jQuery("#rs-go-fullscreen").appendTo(
                            jQuery("#rs-was-here")
                          );
                          var paw = opt.c.closest(
    ...
    getOffContH = function (e) {
      ...
      if (e.split(",").length > 1) {
        ...
        return (
          oc &&
            jQuery.each(oc, function (e, a) {
              jQuery(a).length > 0 && (t += jQuery(a).outerHeight(!0));
            }),
          t
        );
      }
