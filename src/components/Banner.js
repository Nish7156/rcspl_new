                ...
                <div className="fullscreen_slider rev_slider">
                  <ul>
                    <li data-transition="fade">
                      <img
                        src="img/slider-background-1.jpg"
                        alt="slide1"
                        data-bgfit="cover"
                      ...
                      <div
                        ...
                        data-responsive_offset="on"
                      >
                        As the general contructor, we first create the highest
                        level of trust and integrity with our clients. We value
                        our role in the success of your project.
                      </div>
                    ...
                    <li data-transition="fade">
                      <img
                        src="img/slider-background-2.jpg"
                        alt="slide1"
                        data-bgfit="cover"
                        data-bgposition="center center"
                        data-kenburns="on"
                    ...
                    <li data-transition="fade">
                      <img
                        src="img/slider-background-3.jpg"
                        alt="slide1"
                        data-bgfit="cover"
                        data-bgposition="center center"
                        data-kenburns="on"
