                ...
                <div className="row">
                    <div className="col-sm-4">
                        <div className="feature-box">
                            ...
                            <p className="description">1, Niwas Blossom, Sharanpur, Trimbak Link Road, Canada Corner, Nashik - 422005 Maharashtra.</p>
                    ...
                    <div className="col-sm-4">
                        <div className="feature-box">
                            ...
                            <p className="description">2, Chandranil, Gawand Path, Behind State Bank Colony, Next to Gurudwara, Naupada, Thane - 400602</p>
                    ...
                    <div className="col-sm-4">
                        <div className="feature-box">
                            ...
                            <p className="description">‘Saket’, 115, Mahatma Gandhi Nagar, Behind Fire Brigade, Station Road, Aurangabad – 431005.</p>
