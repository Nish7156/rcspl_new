  ...
  e.fn.extend({
      ...
      return (
        ...
        this.each(function () {
          ...
          "hero" == a.sliderType &&
            ...
            (a.jsFileLocation =
              a.jsFileLocation || s("themepunch.revolution.min.js")),
            ...
            e(this).on("scriptsloaded", function () {
              return a.modulesfailing
                ? (n
                    ...
                    .show(),
                  !1)
                : (i.migration != t && (a = i.migration(n, a)),
                  (punchgs.force3D = !0),
                  "on" !== a.simplifyAll &&
    ...
    revkill: function () {
      var a = this,
        n = e(this);
      if (
        (punchgs.TweenLite.killDelayedCallsTo(i.showHideNavElements),
        i.endMoveCaption &&
          punchgs.TweenLite.killDelayedCallsTo(i.endMoveCaption),
        n != t && n.length > 0 && e("body").find("#" + n.attr("id")).length > 0)
      ) {
        n.data("conthover", 1),
        ...
        (r.tonpause = !0),
          ...
          n.unbind("hover, mouseover, mouseenter,mouseleave, resize");
  ...
  e.extend(!0, i, {
    ...
    get_browser: function () {
      ...
      return (
        ...
        (a = a ? [a[1], a[2]] : [t, navigator.appVersion, "-?"]),
        a[0]
      );
    },
    ...
    callingNewSlide: function (t, i, a) {
      var n =
          i.find(".next-revslide").length > 0
            ? i.find(".next-revslide").index()
            : i.find(".processing-revslide").length > 0
            ? i.find(".processing-revslide").index()
            : i.find(".active-revslide").index(),
        o = 0;
      i.find(".next-revslide").removeClass("next-revslide"),
        (a && e.isNumeric(a)) || a.match(/to/g)
          ? (1 === a || -1 === a
              ? ((o = n + a),
                (o = 0 > o ? t.slideamount - 1 : o >= t.slideamount ? 0 : o))
              : ((a = e.isNumeric(a) ? a : parseInt(a.split("to")[1], 0)),
                (o =
                  0 > a ? 0 : a > t.slideamount - 1 ? t.slideamount - 1 : a)),
            i
              .find(".tp-revslider-slidesli:eq(" + o + ")")
      ...
      (a.slotw = Math.ceil(a.width / a.slots)),
        (a.sloth = Math.ceil(
          "fullscreen" == a.sliderLayout
            ? e(window).height() / a.slots
            : a.height / a.slots
        )),
        "on" == a.autoHeight &&
          i !== t &&
          "" !== i &&
          (a.sloth = Math.ceil(i.height() / a.slots));
    },
    setSize: function (i) {
      ...
      if (
        ...
        "fullwidth" == i.sliderLayout &&
          "off" == i.autoHeight &&
          punchgs.TweenLite.set(i.c, { maxHeight: r + "px" }),
        i.c.css({ marginTop: n, marginBottom: o }),
        (i.width = i.ul.width()),
        (i.height = i.ul.height()),
        m(i),
        (i.height = Math.round(
          i.gridheight[i.curWinRange] * (i.width / i.gridwidth[i.curWinRange])
        )),
        i.height > i.gridheight[i.curWinRange] &&
          "on" != i.autoHeight &&
          (i.height = i.gridheight[i.curWinRange]),
        "fullscreen" == i.sliderLayout || i.infullscreenmode)
      ) {
        ...
        if (i.fullScreenOffsetContainer != t) {
          ...
          try {
            ...
            i.fullScreenOffset != t &&
            i.fullScreenOffset.length > 0
              ? (s -=
                  (e(window).height() * parseInt(i.fullScreenOffset, 0)) / 100)
              : i.fullScreenOffset != t &&
                i.fullScreenOffset.length > 0 &&
                (s -= parseInt(i.fullScreenOffset, 0));
          } catch (d) {}
        }
    ...
    enterInViewPort: function (a) {
      a.waitForCountDown && (I(a.c, a), (a.waitForCountDown = !1)),
        a.waitForFirstSlide && (A(a.c, a), (a.waitForFirstSlide = !1)),
        ("playing" == a.sliderlaststatus || a.sliderlaststatus == t) &&
  ...
  var a = i.is_mobile(),
    ...
    o = function (a, o) {
      ...
      return (
        ...
        (r.layeranim = !1),
        (r.migration = !1),
        o.data("version") && o.data("version").toString().match(/5./gi)
          ? (o.find("img").each(function () {
              "on" == e(this).data("kenburns") && (r.kenburns = !0);
            }),
            ("carousel" == a.sliderType ||
              "on" == s.keyboardNavigation ||
              "on" == s.mouseScrollNavigation ||
              "on" == s.touch.touchenabled ||
              s.arrows.enable ||
              s.bullets.enable ||
              s.thumbnails.enable ||
              s.tabs.enable) &&
            ...
            o.find("li").each(function () {
              e(this).data("link") &&
                e(this).data("link") != t &&
                ((r.layeranim = !0), (r.actions = !0));
            }),
            !r.videos &&
              (o.find(".rs-background-video-layer").length > 0 ||
                o.find(".tp-videolayer").length > 0 ||
                o.find("iframe").length > 0 ||
                o.find("video").length > 0) &&
              (r.videos = !0),
        ...
        window.location.href.match(/file:/gi) &&
          ((r.filesystem = !0), (a.filesystem = !0)),
        r.videos &&
          "undefined" == typeof i.isVideoPlaying &&
          n("revolution.extension.video", a),
        r.carousel &&
          "undefined" == typeof i.prepareCarousel &&
          n("revolution.extension.carousel", a),
        r.carousel ||
          "undefined" != typeof i.animateSlide ||
          n("revolution.extension.slideanims", a),
        r.actions &&
          "undefined" == typeof i.checkActions &&
          n("revolution.extension.actions", a),
        r.layeranim &&
          "undefined" == typeof i.handleStaticLayers &&
          n("revolution.extension.layeranimation", a),
        r.kenburns &&
          "undefined" == typeof i.stopKenBurn &&
          n("revolution.extension.kenburn", a),
        r.navigation &&
          "undefined" == typeof i.createNavigation &&
          n("revolution.extension.navigation", a),
        r.migration &&
          "undefined" == typeof i.migration &&
          n("revolution.extension.migration", a),
        r.parallax &&
          "undefined" == typeof i.checkForParallax &&
          n("revolution.extension.parallax", a),
        r
      );
    },
    r = function (e, t) {
      ...
      ("undefined" != typeof punchgs &&
        ...
        (!t.navigation ||
          (t.navigation && "undefined" != typeof i.createNavigation)) &&
        (!t.carousel ||
          (t.carousel && "undefined" != typeof i.prepareCarousel)) &&
        (!t.videos || (t.videos && "undefined" != typeof i.resetVideo)) &&
        (!t.actions || (t.actions && "undefined" != typeof i.checkActions)) &&
        (!t.layeranim ||
          (t.layeranim && "undefined" != typeof i.handleStaticLayers)) &&
        (!t.migration || (t.migration && "undefined" != typeof i.migration)) &&
        (!t.parallax ||
          (t.parallax && "undefined" != typeof i.checkForParallax)) &&
    ...
    d = function (e, t) {
      (t.carousel.maxVisibleItems =
        t.carousel.maxVisibleItems < 1 ? 999 : t.carousel.maxVisibleItems),
        (t.carousel.vertical_align =
          "top" === t.carousel.vertical_align
            ? "0%"
            : "bottom" === t.carousel.vertical_align
            ? "100%"
            : "50%");
    },
    c = function (t, i) {
    ...
    u = function (n, o) {
      ...
      if (
        (n.data("aimg") != t &&
          (("enabled" == n.data("aie8") && i.isIE(8)) ||
            ("enabled" == n.data("amobile") && a)) &&
          n.html(
      ...
      if (
        ...
        (o.conw = n.width()),
        (o.conh = n.height()),
        o.responsiveLevels.length > 1
          ? (o.responsiveLevels[0] = 9999)
          : (o.responsiveLevels = 9999),
        e.each(o.li, function (i, a) {
          ...
          a.addClass("tp-revslider-slidesli"),
            a.data("index") === t &&
              a.data("index", "rs-" + Math.round(999999 * Math.random()));
          var s = new Object();
          (s.params = new Array()),
            (s.id = a.data("index")),
            (s.src =
          ...
          if (
            ...
            u != t &&
              ...
              "slide" != l && (u = "no");
            var h =
                '<div class="tp-caption sft slidelink" style="cursor:pointer;width:100%;height:100%;z-index:' +
                c +
            ...
            (h =
              "no" == u
                ? h + ' data-start="0">'
                : h + "data-actions='" + f + '\' data-start="0">'),
              (h += '<a style="width:100%;height:100%;display:block"'),
              (h =
                "slide" != l ? h + ' target="' + d + '" href="' + l + '"' : h),
              (h +=
        ...
        (o.desktop = !navigator.userAgent.match(
          /(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i
        )),
        (o.autoHeight = "fullscreen" == o.sliderLayout ? "on" : o.autoHeight),
        "fullwidth" == o.sliderLayout &&
          "off" == o.autoHeight &&
          n.css({ maxHeight: o.gridheight[o.curWinRange] + "px" }),
        "auto" != o.sliderLayout &&
          0 == n.closest(".forcefullwidth_wrapper_tp_banner").length &&
          ("fullscreen" !== o.sliderLayout || "on" != o.fullScreenAutoWidth))
      ) {
        var m = n.parent(),
        ...
        (w = w === t ? 0 : w),
          (b = b === t ? 0 : b),
          m.wrap(
            '<div class="forcefullwidth_wrapper_tp_banner" style="position:relative;width:100%;height:auto;margin-top:' +
              b +
              ";margin-bottom:" +
              w +
              '"></div>'
      ...
      if (
        ...
        n.addClass("revslider-initialised"),
          ...
          n.attr("id") == t &&
            n.attr("id", "revslider-" + Math.round(1e3 * Math.random() + 5)),
          (o.firefox13 = !1),
        ...
        (T.addedyt = 0),
          ...
          n.find(".tp-caption, .rs-background-video-layer").each(function () {
            ...
            p !== t && i.checkActions(n, o, p),
              ...
              a &&
                ((1 == r || "true" == r) &&
                  (n.data("autoplayonlyfirsttime", "false"), (r = !1)),
                (1 == s || "true" == s || "on" == s || "1sttime" == s) &&
                  (n.data("autoplay", "off"), (s = "off"))),
              (1 == r || "true" == r || "1sttime" == s) &&
                n
                  .closest("li.tp-revslider-slidesli")
                  .addClass("rs-pause-timer-once"),
              (1 == s || "true" == s || "on" == s || "no1sttime" == s) &&
                n
                  .closest("li.tp-revslider-slidesli")
          ...
          S(n.find(".tp-static-layers img"), o, function () {
            n.find(".tp-static-layers img").each(function () {
              var i = e(this),
                a =
                  i.data("lazyload") != t ? i.data("lazyload") : i.attr("src"),
                n = C(o, a);
              i.attr("src", n.src);
            });
          }),
        ...
        if (z.length < 9 && z.split("slide").length > 1) {
          ...
          1 > H && (H = 1),
            H > o.slideamount && (H = o.slideamount),
            (o.startWithSlide = H - 1);
        }
        n.append(
          '<div class="tp-loader ' +
            o.spinner +
          ...
          0 === n.find(".tp-bannertimer").length &&
            n.append(
        ...
        (o.inviewport = !1),
          O != t &&
            O.enable &&
            ((O.visible_area = parseFloat(O.visible_area) / 100),
            (O.visible_area =
              O.visible_area < 0.001 ? 100 * O.visible_area : O.visible_area),
            i.scrollTicker && i.scrollTicker(o, n)),
          setTimeout(function () {
            "carousel" == o.sliderType && i.prepareCarousel(o),
              !O.enable ||
              (O.enable && o.inviewport) ||
              (O.enable && !o.inviewport && "wait" == !O.outof)
                ? A(n, o)
                : (o.waitForFirstSlide = !0),
              i.manageNavigation && i.manageNavigation(o),
              o.slideamount > 1 &&
                (!O.enable || (O.enable && o.inviewport)
                  ? I(n, o)
                  : (o.waitForCountDown = !0)),
              setTimeout(function () {
        ...
        e(window).on(P, function () {
          return n == t
            ...
            : (0 != e("body").find(n) && f(o),
              void (
                (n.outerWidth(!0) != o.width ||
                  n.is(":hidden") ||
                  ("fullscreen" == o.sliderLayout &&
                    e(window).height() != o.lastwindowheight)) &&
                ((o.lastwindowheight = e(window).height()), v(n, o))
              ));
        }),
          g(n, o),
          f(o),
          o.fallbacks.disableFocusListener ||
            "true" == o.fallbacks.disableFocusListener ||
            o.fallbacks.disableFocusListener === !0 ||
            j(n, o);
      }
    },
    p = function (t, i) {
            ...
            n.layersonhover &&
              e.each(n.layersonhover, function (e, a) {
                ...
                var o = a.data("timeline_out"),
                  r =
                    "carousel" === n.sliderType
                      ? 0
                      : n.width / 2 - (n.gridwidth[n.curWinRange] * n.bw) / 2,
                  s = 0,
                  l = a.closest(".tp-revslider-slidesli");
                if (
                  l.hasClass("active-revslide") ||
                  l.hasClass("processing-revslide")
                ) {
    ...
    f = function (t) {
      ...
      if (
        ...
        var n = Math.ceil(
          t.c.closest(".forcefullwidth_wrapper_tp_banner").offset().left - a
        );
      ...
      t.slayers &&
        ...
        punchgs.TweenLite.set(t.slayers, { left: a });
    },
    g = function (a, n, o) {
      var r = a.parent();
      e(window).width() < n.hideSliderAtLimit
        ? (a.trigger("stoptimer"),
          "none" != r.css("display") && r.data("olddisplay", r.css("display")),
          r.css({ display: "none" }))
        : a.is(":hidden") &&
          o &&
          (r.css(
            r.data("olddisplay") != t &&
              "undefined" != r.data("olddisplay") &&
              "none" != r.data("olddisplay")
    ...
    v = function (a, n) {
      if (
        (1 == n.infullscreenmode && (n.minHeight = e(window).height()),
        l(n),
        l(n, !0),
        !i.resizeThumbsTabs || i.resizeThumbsTabs(n) === !0)
      ) {
        if (
          (g(a, n, !0),
          f(n),
          "carousel" == n.sliderType && i.prepareCarousel(n, !0),
          a === t)
        )
          return !1;
        i.setSize(n),
        ...
        w(a, n, a, 2),
          "standard" === n.sliderType &&
            (punchgs.TweenLite.set(r.find(".defaultimg"), { opacity: 0 }),
            o.find(".defaultimg").css({ opacity: 1 })),
          "carousel" == n.sliderType &&
            n.lastconw != n.conw &&
            (clearTimeout(n.pcartimer),
            (n.pcartimer = setTimeout(function () {
              i.prepareCarousel(n, !0);
            }, 100)),
            (n.lastconw = n.conw)),
          i.manageNavigation && i.manageNavigation(n),
          i.animateTheCaptions &&
            i.animateTheCaptions(a.find(".active-revslide"), n, !0),
          "on" == r.data("kenburns") &&
            i.startKenBurn(r, n, r.data("kbtl").progress()),
          "on" == o.data("kenburns") &&
            i.startKenBurn(o, n, o.data("kbtl").progress()),
    ...
    y = function (n, o) {
      if (
        ...
        o.li.each(function (i) {
          ...
          ((o.startWithSlide != t && n == o.startWithSlide) ||
            (o.startWithSlide === t && 0 == i)) &&
            a.addClass("next-revslide"),
      ...
      n.parent().css({ overflow: "visible" }),
        o.li.find(">img").each(function () {
          ...
          n.addClass("defaultvid").css({ zIndex: 30 }),
            ...
            "on" == o.panZoomDisableOnMobile &&
              a &&
              (i.data("kenburns", "off"), i.data("bgfit", "cover")),
            i.wrap(
              '<div class="slotholder" style="width:100%;height:100%;"></div>'
            ),
          ...
          i.closest(".slotholder").data(r),
            n.length > 0 &&
              r.bgparallax != t &&
              n.data("bgparallax", r.bgparallax),
            "none" != o.dottedOverlay &&
              o.dottedOverlay != t &&
              i
                .closest(".slotholder")
                .append(
                  '<div class="tp-dottedoverlay ' + o.dottedOverlay + '"></div>'
                );
          var s = i.attr("src");
          (r.src = s),
          ...
          i.replaceWith(d),
            ...
            i.data(r),
            i.attr("src", s),
            ("standard" === o.sliderType || "undefined" === o.sliderType) &&
              i.css({ opacity: 0 });
        });
    },
    w = function (t, i, a, n) {
          ...
          e.each(i.loadqueue, function (e, i) {
            ...
            (o = o.substring(0, o.length - 1) + n),
              ...
              (b(r) === b(decodeURIComponent(t.src)) ||
                ...
                b(i.src).replace(/^.*\/\/[^\/]+/, "") ===
                  b(decodeURIComponent(t.src)).replace(/^.*\/\/[^\/]+/, "") ||
                ("file://" === window.location.origin &&
                  b(t.src).match(new RegExp(n)))) &&
    ...
    L = function (i, a, n) {
      i.find("img,.defaultimg").each(function () {
        var i = e(this),
          o =
            i.data("lazyload") !== t && "undefined" !== i.data("lazyload")
              ? i.data("lazyload")
              : i.attr("src");
    ...
    S = function (a, n, o) {
      ...
      a.find("img,.defaultimg").each(function () {
        ...
        if (
          ...
          l !== t &&
          l.progress &&
          l.progress.match(/loaded/g)
        ) {
          if ((o.attr("src", l.src), o.hasClass("defaultimg")))
            i.isIE(8)
              ? defimg.attr("src", l.src)
              : o.css({ backgroundImage: 'url("' + l.src + '")' }),
        ...
        if (
          (l &&
            l.progress &&
            l.progress.match(/inprogress|inload|prepared/g) &&
            (e.now() - o.data("start-to-load") < 5e3
              ? (r = !0)
              : console.error(s + "  Could not be loaded !")),
          1 == n.youtubeapineeded &&
            (!window.YT || YT.Player == t) &&
            ((r = !0),
            e.now() - n.youtubestarttime > 5e3 && 1 != n.youtubewarning))
        ) {
          n.youtubewarning = !0;
          var u = "YouTube Api Could not be loaded !";
          "https:" === location.protocol &&
            (u += " Please Check and Renew SSL Certificate !"),
            console.error(u),
            n.c.append(
        ...
        if (
          1 == n.vimeoapineeded &&
          !window.Froogaloop &&
          ((r = !0), e.now() - n.vimeostarttime > 5e3 && 1 != n.vimeowarning)
        ) {
          n.vimeowarning = !0;
    ...
    A = function (t, a) {
      if (
        (clearTimeout(a.waitWithSwapSlide),
        t.find(".processing-revslide").length > 0)
      )
        return (
      ...
      return o.index() === n.index()
        ...
        : (o.removeClass("next-revslide").addClass("processing-revslide"),
          "on" == a.stopLoop &&
            o.index() == a.lastslidetoshow - 1 &&
            (t.find(".tp-bannertimer").css({ visibility: "hidden" }),
            t.trigger("revolution.slide.onstop"),
            (a.noloopanymore = 1)),
          o.index() === a.slideamount - 1 &&
            ((a.looptogo = a.looptogo - 1),
          ...
          void S(o, a, function () {
            o.find(".rs-background-video-layer").each(function () {
              ...
              t.hasClass("HasListener") ||
                (t.data("bgvideo", 1), i.manageVideoLayer(t, a)),
    ...
    z = function (e, a, n) {
      ...
      (d.nextslide = r),
        ...
        (e.videoplaying = !1),
        r.data("delay") != t
          ? ((e.cd = 0), (e.delay = r.data("delay")))
          : (e.delay = e.origcd);
      var c = o.index(),
        u = r.index();
      (e.sdir = c > u ? 1 : 0),
        "arrow" == e.sc_indicator &&
          (0 == c && u == e.slideamount - 1 && (e.sdir = 1),
          c == e.slideamount - 1 && 0 == u && (e.sdir = 0)),
        ...
        o.index() != r.index() &&
          1 != e.firststart &&
          i.removeTheCaptions &&
          i.removeTheCaptions(o, e),
        r.hasClass("rs-pause-timer-once") || r.hasClass("rs-pause-timer-always")
          ? (e.videoplaying = !0)
      ...
      if ("carousel" == e.sliderType)
        ...
        (h = new punchgs.TimelineLite({
          ...
          h.pause(),
          1 == e.firststart &&
            (punchgs.TweenLite.set(o, { autoAlpha: 0 }), (e.firststart = 0)),
          punchgs.TweenLite.set(o, { zIndex: 18 }),
          punchgs.TweenLite.set(r, { autoAlpha: 0, zIndex: 20 }),
          "prepared" == r.data("differentissplayed") &&
            (r.data("differentissplayed", "done"),
            r.data("transition", r.data("savedtransition")),
            r.data("slotamount", r.data("savedslotamount")),
            r.data("masterspeed", r.data("savedmasterspeed"))),
        ...
        var f =
            r.data("transition") !== t
              ? r.data("transition").split(",")
              : "fade",
          g = r.data("nexttransid") == t ? -1 : r.data("nexttransid");
        "on" == r.data("randomtransition")
          ? (g = Math.round(Math.random() * f.length))
          : (g += 1),
          g == f.length && (g = 0),
          r.data("nexttransid", g);
        var v = f[g];
        e.ie &&
          ("boxfade" == v && (v = "boxslide"),
          "slotfade-vertical" == v && (v = "slotzoom-vertical"),
          "slotfade-horizontal" == v && (v = "slotzoom-horizontal")),
          i.isIE(8) && (v = 11),
          (h = i.animateSlide(p, v, n, e, r, o, l, s, h)),
          "on" == l.data("kenburns") &&
            (i.startKenBurn(l, e),
            h.add(punchgs.TweenLite.set(l, { autoAlpha: 0 }))),
          h.pause();
      }
      "off" != e.parallax.type &&
    ...
    H = function (n, o, r, s, l, d, c) {
      "carousel" === o.sliderType ||
        ...
        ("scroll" == o.parallax.type ||
          ...
          ((o.lastscrolltop = -999), i.scrollHandling(o)),
        c.clear(),
        s.data("kbtl") != t &&
          (s.data("kbtl").reverse(), s.data("kbtl").timeScale(25)),
        "on" == r.data("kenburns") &&
          (r.data("kbtl") != t
            ? (r.data("kbtl").timeScale(1), r.data("kbtl").play())
            : i.startKenBurn(r, o)),
        ...
        d.find(".rs-background-video-layer").each(function () {
          if (a) return !1;
          var t = e(this);
          i.stopVideo && (i.resetVideo(t, o), i.stopVideo(t, o)),
            punchgs.TweenLite.to(t, 1, {
              autoAlpha: 0,
              ease: punchgs.Power3.easeInOut,
              delay: 0.2,
            });
    ...
    I = function (n, o) {
      (o.cd = 0),
        (o.loop = 0),
        (o.looptogo =
          o.stopAfterLoops != t && o.stopAfterLoops > -1
            ? o.stopAfterLoops
            : 9999999),
        (o.lastslidetoshow =
          o.stopAtSlide != t && o.stopAtSlide > -1 ? o.stopAtSlide : 999),
        (o.stopLoop = "off"),
      ...
      n.on("stoptimer", function () {
        ...
        n.on("restarttimer", function () {
          var t = e(this).find(".tp-bannertimer");
          return o.mouseoncontainer && "on" == o.navigation.onHoverStop && !a
            ? !1
            : (1 === o.noloopanymore ||
                (o.viewPort.enable && !o.inviewport) ||
      ...
      r.data(
        ...
        o.slideamount > 1 && (0 != o.stopAfterLoops || 1 != o.stopAtSlide)
          ...
          : ((o.noloopanymore = 1), n.trigger("nulltimer")),
        n.on("tp-mouseenter", function () {
          (o.mouseoncontainer = !0),
            "on" != o.navigation.onHoverStop ||
              a ||
              (n.trigger("stoptimer"), n.trigger("revolution.slide.onpause"));
        }),
        n.on("tp-mouseleft", function () {
          (o.mouseoncontainer = !1),
            1 != n.data("conthover") &&
              "on" == o.navigation.onHoverStop &&
              ((1 == o.viewPort.enable && o.inviewport) ||
                0 == o.viewPort.enable) &&
              (n.trigger("revolution.slide.onresume"), n.trigger("starttimer"));
        });
    },
    P =
      ((function () {
